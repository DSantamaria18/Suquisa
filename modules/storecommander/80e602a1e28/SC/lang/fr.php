...
'new product manufacturer default'=>'marque/fabricant par défaut des nouveaux produits',
...
'export root category'=>'exporter la catégorie accueil',
...
'Set to 1 if you wish to open PS windows in a new browser tab instead of SC window. (forced to 1 if SC is run on iPad)'=>'Indiquez 1 si vous souhaitez ouvrir les fenêtre de Prestashop dans de nouveaux onglets plutôt que dans des fenêtre de l\'interface. (Sur iPad, cette option est forcée à 1)',
