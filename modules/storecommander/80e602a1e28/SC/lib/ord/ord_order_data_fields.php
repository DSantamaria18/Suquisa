...
$colSettings['id_carrier']=array('text' => _l('Carrier'),'width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#select_filter_strict');
...
$colSettings['company']=array('text' => _l('Company'),'width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#select_filter');
...
$colSettings['total_shipping_tax_incl']=array('text' => _l('Total shipping inc. tax'),'width'=>70,'align'=>'right','type'=>'ro'/*'edn'*/,'sort'=>'int','color'=>'','filter'=>'#numeric_filter','format'=>'0.00','footer'=>'#stat_total');
$colSettings['total_shipping_tax_excl']=array('text' => _l('Total shipping exc. tax'),'width'=>70,'align'=>'right','type'=>'ro'/*'edn'*/,'sort'=>'int','color'=>'','filter'=>'#numeric_filter','format'=>'0.00','footer'=>'#stat_total');

$colSettings['carrier_tax_rate']=array('text' => _l('Carrier tax rate'),'width'=>70,'align'=>'right','type'=>'ro'/*'edn'*/,'sort'=>'int','color'=>'','filter'=>'#numeric_filter','format'=>'0.00','footer'=>'#stat_total');
...
if ($view=='grid_picking' || (is_array($cols) && in_array("id_order_detail", $cols)))
...
$colSettings['pdf']=array('text' => _l('PDF'),'width'=>50,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>' ');
...
$colSettings['del_address1']=array('text' => _l('Del.').' '._l('Address').' 1','width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#text_filter');
$colSettings['del_address2']=array('text' => _l('Del.').' '._l('Address').' 2','width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#text_filter');
$colSettings['del_postcode']=array('text' => _l('Del.').' '._l('Postcode'),'width'=>70,'align'=>'left','type'=>'ro','sort'=>'int','color'=>'','filter'=>'#text_filter');
$colSettings['del_city']=array('text' => _l('Del.').' '._l('City'),'width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#text_filter');
$colSettings['del_id_country']=array('text' => _l('Del.').' '._l('Country'),'width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#text_filter');
$colSettings['del_id_state']=array('text' => _l('Del.').' '._l('State'),'width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#text_filter');
...
$colSettings['inv_address1']=array('text' => _l('Inv.').' '._l('Address').' 1','width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#text_filter');
$colSettings['inv_address2']=array('text' => _l('Inv.').' '._l('Address').' 2','width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#text_filter');
$colSettings['inv_postcode']=array('text' => _l('Inv.').' '._l('Postcode'),'width'=>70,'align'=>'left','type'=>'ro','sort'=>'int','color'=>'','filter'=>'#text_filter');
$colSettings['inv_city']=array('text' => _l('Inv.').' '._l('City'),'width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#text_filter');
$colSettings['inv_id_country']=array('text' => _l('Inv.').' '._l('Country'),'width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#text_filter');
$colSettings['inv_id_state']=array('text' => _l('Inv.').' '._l('State'),'width'=>70,'align'=>'left','type'=>'ro','sort'=>'str','color'=>'','filter'=>'#text_filter');
