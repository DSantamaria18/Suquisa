 ...
 **/
	...
	function getStatusList()
	{
		...
		{
			echo '<item id="'.$row['id_order_state'].'" im0="'.$icon.'" im1="'.$icon.'" im2="'.$icon.'" imwidth="0" imheight="0" '.(Tools::getBrightness($row['color'])<128?'aCol="White"':'aCol="rgb(100, 100, 100)"').' style="background-color:'.$row['color'].'"><itemtext><![CDATA['.$row['name'].']]></itemtext><userdata name="is_segment">0</userdata></item>';
		}
	}
