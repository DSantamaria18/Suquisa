...
?>
	...
	ord_filter.attachEvent("onCheck",function(idfilter, state){
			...
			if(!in_array(idfilter,new Array('3days','5days','10days','15days','30days','3months','6months','1year','all','period','from_to','inv_from_to')))
			{
				statusselection=ord_filter.getAllChecked();
				$.cookie('sc_ord_statusselection',statusselection, { expires: 60 });
			}
			if(in_array(idfilter,new Array('3days','5days','10days','15days','30days','3months','6months','1year','all')))
			{
