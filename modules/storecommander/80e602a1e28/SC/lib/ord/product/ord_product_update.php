 ...
 **/
	...
	if(isset($_POST["!nativeeditor_status"]) && trim($_POST["!nativeeditor_status"])=="updated"){
		...
		$fields=array('product_name','product_quantity','product_price','product_ean13','product_upc','product_reference','product_supplier_reference','product_weight','tax_name','tax_rate');
		$todo=array();
