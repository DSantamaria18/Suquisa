...
<?php
	...
	{
?>
	'<item id="cat_attributes" text="<?php echo _l('Attributes and groups',1)?>" img="lib/img/asterisk_yellow.png" imgdis="lib/img/asterisk_yellow.png"/>'+
<?php
	}
	if ((version_compare(_PS_VERSION_, '1.5.0.0', '<') || Feature::isFeatureActive()) && _r("MEN_CAT_FEATURES"))
	{
?>
	'<item id="cat_features" text="<?php echo _l('Features',1)?>" img="lib/img/eye.png" imgdis="lib/img/eye.png"/>'+
<?php
	}
...
<?php
		...
		if (Configuration::get('SC_VATSCHEDULER_INSTALLED'))
		{
?>
	'<item id="acc_vatscheduler" text="<?php echo _l('VAT Scheduler',1)?>" img="lib/img/percent.png" imgdis="lib/img/percent.png"></item>'+
<?php
		}else{
?>
	'<item id="teaser_vatscheduler" text="<?php echo _l('VAT Scheduler',1)?>" img="lib/img/percent.png" imgdis="lib/img/percent.png">'+
		'<item id="teaser_vatscheduler_read" text="<?php echo _l('Read more',1)?>" img="lib/img/tick.png" imgdis="lib/img/tick.png"/>'+
	'</item>'+
<?php
		}
?>
	...
	<?php if(SCMS) {
		...
		if(!empty($shops) && count($shops)>1)
		{
			...
			foreach($shops as $shop)
			{
				...
				if(!empty($url[0]["url"]))
				{
					$shopUrls[$shop["id_shop"]] = $url[0]["url"];
