...
/* à revoir avec filtres qui correspondent bien aux colonnes */
		for(var i=0;i<cus_grid.getColumnsNum();i++)
		{
			var colId = customer_columns[i];
			if (cus_grid.getFilterElement(i)!=undefined && oldFilters[colId]!=undefined)
			{
				cus_grid.getFilterElement(i).value=oldFilters[colId];
			}
		}
