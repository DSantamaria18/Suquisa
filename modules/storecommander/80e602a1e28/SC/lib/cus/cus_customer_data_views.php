...
$grids=array(
		...
		'grid_address' => 	'id_address,id_customer,firstname,lastname,'.(_s('CUS_USE_COMPANY_FIELDS')?"company,":"").'address1,address2,postcode,city,id_state,id_country,phone,phone_mobile,invoice,delivery',
...
if (version_compare(_PS_VERSION_, '1.5.0.0', '>='))
{
	$grids=array(
			...
			'grid_address' => 	'id_address,'.(SCMS?'id_shop,':'').'id_customer,firstname,lastname,'.(_s('CUS_USE_COMPANY_FIELDS')?"company,":"").'address1,address2,postcode,city,id_state,id_country,phone,phone_mobile,invoice,delivery',
