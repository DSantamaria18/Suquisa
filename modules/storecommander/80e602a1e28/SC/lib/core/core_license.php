...
<div id="licenseContent" style="padding:10px;">
	...
	<input type="text" id="newLicense" value="<?php echo SCI::getConfigurationValue('SC_LICENSE_KEY');?>"/><br/><br/>
	<input type="button" value="<?php echo _l('Save');?>" onclick="$.get('index.php?ajax=1&act=core_license&a=set&license='+$('#newLicense').val(),function(data){if (data=='OK') {alert('<?php echo _l('License key saved! Thank you!',1);?>');window.location='index.php?licupdate=1';}else{$('#licenseContent').html(data);}});"/><br/><br/><br/>
