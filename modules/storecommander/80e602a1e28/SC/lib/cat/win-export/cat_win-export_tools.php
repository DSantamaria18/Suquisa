 ...
 **/
	...
	//	$array[_l('attribute of combination - texture',1)]="attribute_texture";
		...
		$array[_l('image_link',1)]="image_link";
		$array[_l('image_legend',1)]="image_legend";
		$array[_l('image_id',1)]="image_id";
		$array[_l('imageURL',1)]="links_to_all_images";
	...
	{
		global $categoryNameByID,$categoriesProperties,$cacheCategoryPath;
	...
	{
		if (in_array(Tools::strtoupper($value),array('1','YES','TRUE','VRAI','OUI'))) return true;
		return false;
	}