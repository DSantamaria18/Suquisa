 ...
 **/
	...
	if(Tools::getValue('act','')=='cat_win-export_config_update')
	{
		...
		$fields=array('mapping','shops','categoriessel','exportfilename','exportdisabledproducts','exportcombinations','exportoutofstock','exportbydefaultcategory','shippingfee','shippingfeefreefrom','fieldsep','valuesep','enclosedby','iso','firstlinecontent','lastexportdate');
