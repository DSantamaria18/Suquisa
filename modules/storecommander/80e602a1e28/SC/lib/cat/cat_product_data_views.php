...
if (version_compare(_PS_VERSION_, '1.4.0.0', '>='))
{
	$grids=array(
			...
			'grid_price' => 		'id,image,reference,name,wholesale_price,price,margin,id_tax_rules_group,price_inc_tax,unit_price_ratio,unity,reduction_price,ecotax,discountprice,id_manufacturer,id_supplier,active',
