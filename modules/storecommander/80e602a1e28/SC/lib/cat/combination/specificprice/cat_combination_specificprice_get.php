...
<head>
<beforeInit>
<call command="attachHeader"><param><![CDATA[#text_filter,#text_filter<?php if(SCMS){ ?>,#select_filter,#select_filter<?php } ?>,#select_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#select_filter,#select_filter]]></param></call>
</beforeInit>
