...
<?php 
echo (in_array($user_lang_iso,array('cs','da','de','es','fi','fr','it','ja','lv','nl','pt','br','ru','sv'))?'<script type="text/javascript" src="'.SC_PLUPLOAD.'js/i18n/'.$user_lang_iso.'.js"></script>':'');
