 ...
 **/
	...
	if(Tools::getValue('act','')=='cat_win-import_config_update')
	{
		...
		$fields=array('supplier','fieldsep','valuesep','utf8','idby','iffoundindb','fornewproduct','forfoundproduct','mapping','firstlinecontent','createcategories','importlimit','createelements');
