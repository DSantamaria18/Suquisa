...
<script type="text/javascript">
	...
	$(window).ready(function(){
		noerror=true;
		$("#uploaderImportCSV").pluploadQueue({
			// General settings
			runtimes : 'gears,html5,flash,silverlight,browserplus',
			url : 'index.php?ajax=1&act=all_upload&obj=importcsv',
			max_file_size : '30mb',
			chunk_size : '500ko',
			unique_names : false,
			...
			init : {
	            BeforeUpload : function(up){
					$("#uploaderImportCSV").pluploadQueue().settings.url='index.php?ajax=1&act=all_upload&obj=importcsv';
	            },
	            UploadComplete : function(up){
					top.wImport._uploadWindow.hide();
					top.displayOptions();
	            }
			},
      // Flash settings  
      ...
      silverlight_xap_url : '<?php echo SC_PLUPLOAD;?>js/plupload.silverlight.xap' 
		...
		$('form').submit(function(e){
			var uploader = $('#uploaderImportCSV').pluploadQueue();
...
#divAddImportCSV{ width:inherit;height:inherit;}
#uploaderImportCSV{ width:inherit;height:inherit;}
.formDragDrop{ width:inherit;height:inherit;margin:0;}
</style>	

<div id="divAddImportCSV">
	<form class="formDragDrop">
		<div id="uploaderImportCSV">
