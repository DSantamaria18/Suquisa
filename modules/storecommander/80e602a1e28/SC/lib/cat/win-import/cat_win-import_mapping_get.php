...
*/
	if ($importConfig[$imp_opt_file]['firstlinecontent']!='')
	{
		...
		$DATAFILE=file_get_contents(SC_CSV_IMPORT_DIR.$imp_opt_file);
		$DATA = preg_split("/(?:\r\n|\r|\n)/", $DATAFILE); 
...
<column id="file_field" width="140" type="ro" align="left" sort="na"><?php echo _l('File field')?></column>
<column id="db_field" width="140" type="coro" align="left" sort="na"><?php echo _l('Database field')?></column>
