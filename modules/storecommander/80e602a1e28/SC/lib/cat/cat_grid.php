...
?>
		...
		if (itemId=="massupdate_price"){
			...
			if (todo!='' && todo!=null){
				selection=cat_grid.getSelectedRowId();
				if (selection!='' && selection!=null)
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=price',{'productlist':selection, 'todo':todo},function(data){
		...
		if (itemId=="massupdate_pricetax"){
			...
			if (todo!='' && todo!=null){
				selection=cat_grid.getSelectedRowId();
				if (selection!='' && selection!=null)
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=pricetax',{'productlist':selection, 'todo':todo},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
						});
			}
		}
		if (itemId=="massupdate_quantity"){
			...
			if (todo!='' && todo!=null){
				selection=cat_grid.getSelectedRowId();
				if (selection!='' && selection!=null)
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=quantity&id_lang='+SC_ID_LANG,{'productlist':selection, 'todo':todo},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
							if(data!="")
							{
								var explode = data.split("|");
								if(explode[0] == "quantity" && explode[1] != undefined && explode[1]!="")
								{
									var msg = '<?php echo _l('The quantity of products below was not modified because they possess combinations',1)?> :<br/>'+explode[1];
									dhtmlx.message({text:msg,type:'error',expire:10000});
								}
							}
						});
		...
		if (itemId=="massupdate_margin"){
			...
			if (todo!='' && todo!=null){
				selection=cat_grid.getSelectedRowId();
				if (selection!='' && selection!=null)
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=margin',{'productlist':selection, 'todo':todo},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
						});
			}
		}
		if (itemId=="massupdate_combi_price"){
			...
			if (todo!='' && todo!=null){
				selection=cat_grid.getSelectedRowId();
				if (selection!='' && selection!=null)
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=combi_price',{'productlist':selection, 'todo':todo},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
						});
			}
		}
		if (itemId=="massupdate_combi_pricetax"){
			...
			if (todo!='' && todo!=null){
				selection=cat_grid.getSelectedRowId();
				if (selection!='' && selection!=null)
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=combi_pricetax',{'productlist':selection, 'todo':todo},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
						});
			}
		}
		if (itemId=="massupdate_combi_quantity"){
			...
			if (todo!='' && todo!=null){
				selection=cat_grid.getSelectedRowId();
				if (selection!='' && selection!=null)
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=combi_quantity',{'productlist':selection, 'todo':todo},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
						});
			}
		}
		if (itemId=="massupdate_defaultcombitocheapest"){
			if (confirm('<?php echo _l('This will set the cheapest combination as default combination for each seleted product. Continue?',1)?>')){
				...
				if (selection!='' && selection!=null)
				{
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=defaultcombination&todo=cheapest',{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
						});
				}
			}
		...
		if (itemId=="massupdate_defaultcombitoinstockandcheapest"){
			if (confirm('<?php echo _l('This will set the cheapest combination in stock as default combination for each seleted product. Continue?',1)?>')){
				...
				if (selection!='' && selection!=null)
				{
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=defaultcombination&todo=instockandcheapest',{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
						});
				}
			}
		...
		if (itemId=="massupdate_round_price_1"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				if (selection!='' && selection!=null)
				{
					...
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round&todo=1&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_2"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round&todo=2&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_3"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round&todo=3&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_4"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round&todo=4&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_5"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round&todo=5&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_6"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round&todo=6&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_7"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round&todo=7&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_8"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round&todo=8&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_9"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round&todo=9&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_help"){
			window.open('<?php echo _l('http://www.storecommander.com/redir.php?dest=20131127',1)?>','_blank');
		}
		if (itemId=="massupdate_round_price_combi_1"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round_combi&todo=1&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_combi_2"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round_combi&todo=2&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_combi_3"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round_combi&todo=3&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_combi_4"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round_combi&todo=4&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_combi_5"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round_combi&todo=5&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_combi_6"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round_combi&todo=6&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_combi_7"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round_combi&todo=7&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_combi_8"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round_combi&todo=8&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		if (itemId=="massupdate_round_price_combi_9"){
			if (confirm('<?php echo _l('Are you sure that you want to round all these prices up?',1)?>')){
				...
				{
					 var column=cat_grid.getColumnId(lastColumnRightClicked);
					$.post('index.php?ajax=1&act=cat_product_massupdate<?php echo $massupdate_suffix; ?>&field=mass_round_combi&todo=9&column='+column,{'productlist':selection},function(data){
							displayProducts('cat_grid.selectRowById('+lastProductSelID+',true,true,true);');
					});
				}
			}
		...
		cat_grid.loadXML("index.php?ajax=1&act=cat_product_get&tree_mode="+tree_mode+"&productsfrom="+displayProductsFrom+"&idc="+catselection+"&view="+gridView+params_supp+"&id_lang="+SC_ID_LANG+"&"+new Date().getTime(),function(){
			...
			if(idxName!==false)
			{
				cat_grid.setCustomSorting(function(a,b,ord,a_id,b_id){
					a = latinise(cat_grid.cells(a_id,idxName).getTitle()).toLowerCase(); 
					b = latinise(cat_grid.cells(b_id,idxName).getTitle()).toLowerCase();
