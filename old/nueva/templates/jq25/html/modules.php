...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'jq-nostyle';
  $styles = array(
    'jq-nostyle' => 'modChrome_artnostyle',
    'jq-block' => 'modChrome_artblock',
    'jq-article' => 'modChrome_artarticle',
    'jq-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'jq-...'        - overwrites the default module style.
  //  'suffix jq-...' - overwrites the default style and adds suffix to the module and
  //                     to its elements, does not add jq-... to the module elements.
...
<!-- begin nostyle -->
<div class="jq-nostyle<?php echo $params->get('moduleclass_sfx'); ?>">
