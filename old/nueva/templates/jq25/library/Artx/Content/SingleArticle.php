...
class ArtxContentSingleArticle extends ArtxContentItem
{
    ...
    public function printIcon()
    {
        ...
        if ($this->showIcons) {
            ...
            $text = str_replace('icon-print', 'jq-postprinticon', $text);
        }
        return $text;
    }
    ...
    {
        return '<div class="jq-article">' . $toc . '</div>';
    }

    public function intro($intro)
    {
        return '<div class="jq-article">' . $intro . '</div>';
    }

    public function text($text)
    {
        return '<div class="jq-article">' . $text . '</div>';
    }
