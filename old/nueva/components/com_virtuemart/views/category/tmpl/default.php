...
<div class="row">
			...
			<div class="spacer">
			    <div class="width20 floatright center"><h3 style="text-align: center;">Proveedor</h3></div>
			    <div class="width20 floatright center"><h3 style="text-align: center;">Código</h3></div>  
				<div class="width20 floatleft"><h3>Artículo</h3></div>
				<div class="width60 center"><h3>Descripcion</h3></div>
				<div class="clear"></div>  
		    </div> <!-- end of product -->
		<div class="horizontal-separator"></div>
					<div class="clear"></div>
	...
	<?php
		...
		<div class="product floatleft<?php echo $Browsecellwidth . $show_vertical_separator ?>">
			<div class="spacer">
			    <div class="width20 floatright center">
				    <a title="<?php echo $product->product_name ?>" rel="vm-additional-images" href="<?php echo $product->link; ?>">
						<?php
								$logoManufacturer = shopFunctionsF::getManufacturerDesc($product->virtuemart_product_id );
						 //  if (!empty($product->images[0])){
						//	 echo $product->images[0]->displayMediaThumb('class="browseProductImage"', false);
						//	}
							if (!empty($logoManufacturer)){
								echo $logoManufacturer;
							}
						?>
					 </a>
				</div>
...
?>
<p><br><b>* Estamos actualizando nuestro catálogo de productos.</b></p>
</div><!-- end browse-view -->